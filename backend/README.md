...
## Project Structure
    ...
    ├── testapiautoteammemb_62903  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_62903`
...
2. Clone this repo and `cd testapiautoteammemb_62903`
